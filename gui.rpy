...
define gui.text_font = "aceattorney.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "aceattorney.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "aceattorney.ttf"
...
define gui.name_xpos = 19
define gui.name_ypos = -32
...
define gui.dialogue_ypos = 13

## Максимальная ширина текста диалога в пикселях.
define gui.dialogue_width = 585
...
define gui.choice_button_width = 364
...
define gui.slot_button_width = 128
define gui.slot_button_height = 95
...
define config.thumbnail_width = 118
define config.thumbnail_height = 67
...
## Местоположение, ширина и выравнивание заголовка, показывающего имя говорящего
## персонажа.
define gui.nvl_name_xpos = 198
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 70
define gui.nvl_name_xalign = 1.0

## Местоположение, ширина и выравнивание диалогового текста.
define gui.nvl_text_xpos = 208
define gui.nvl_text_ypos = 4
define gui.nvl_text_width = 272
define gui.nvl_text_xalign = 0.0

## Местоположение, ширина и выравнивание текста nvl_thought (текст от лица
## персонажа nvl_narrator).
define gui.nvl_thought_xpos = 111
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 359
define gui.nvl_thought_xalign = 0.0

## Местоположение кнопок меню NVL.
define gui.nvl_button_xpos = 208
...
init python:
    ...
    def small():
        ...
        gui.interface_text_size = 14
        gui.button_text_size = 14
        gui.label_text_size = 16

        ## Регулирует местоположение текстового окна.
        gui.textbox_height = 111
        gui.name_xpos = 37
        gui.dialogue_xpos = 42
        gui.dialogue_width = 507

        ## Изменяет размеры и интервалы различных объектов.
        gui.slider_size = 17

        gui.choice_button_width = 571
        gui.choice_button_text_size = 14

        gui.navigation_spacing = 10
        gui.pref_button_spacing = 5

        gui.history_height = 88
        gui.history_text_width = 318
        ...
        gui.nvl_name_width = 141
        gui.nvl_name_xpos = 150

        gui.nvl_text_width = 422
        gui.nvl_text_xpos = 159
        gui.nvl_text_ypos = 3

        gui.nvl_thought_width = 571
        gui.nvl_thought_xpos = 10

        gui.nvl_button_width = 571
